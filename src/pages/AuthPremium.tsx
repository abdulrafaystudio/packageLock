...
import PremiumPackageCard from '@/components/auth/PremiumPackageCard';
...
const AuthPremium = () => {
  ...
  const {
    ...
    handleSubmit,
    toggleAuthMode,
  } = useUnifiedAuthForm({ defaultToSignUp: true, packageType: 'premium' });
      ...
      <main className="pt-20 pb-16 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            <PremiumPackageCard isYearly={isYearly} />
            <SimplifiedAuthForm
              isSignUp={isSignUp}
              isLoading={isLoading}
              formData={formData}
