...
const ForBrokers = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      monthlyPrice: "$199",
      yearlyPrice: "$1990",
      description: "Unlimited deal creation",
      features: [
        "Everything in Standard",
        "Upload unlimited amount of deals",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">
              Plans for <span className="text-primary-600">Brokers</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8 transition-colors duration-300">
              Choose the perfect plan for your brokerage and investment needs
            </p>
